...
SOURCE_DIR="tests"                               # tests-only repo: no separate source package
MIN_COVERAGE=15  # Template default — set to (actual coverage - 1%) after first test run. See test-coverage-targets.mdc
