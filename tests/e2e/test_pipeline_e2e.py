...
def test_pipeline_single_date_single_venue(http_client, base_urls):
...
@pytest.mark.full_e2e
def test_pipeline_multi_date_multi_venue(http_client, base_urls):
...
@pytest.mark.full_e2e
def test_pipeline_perf_baseline(http_client, base_urls):
